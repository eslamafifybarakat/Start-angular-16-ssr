...
export class DiscountPolicyComponent {
  ...
  private updateMetaTags(): void {
    this.metadataService.updateTitle('تلبينة | سياسة الخصم');
    this.metadataService.updateMetaTagsName([
      { name: 'title', content: 'تلبينة | سياسة الخصم' },
      ...
      { name: 'twitter:title', content: 'تلبينة | سياسة الخصم' },
    ...
    this.metadataService.updateMetaTagsProperty([
      ...
      { property: 'og:title', content: 'تلبينة | سياسة الخصم' },
